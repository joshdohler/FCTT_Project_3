...
def R1_final(I, r1, b1, c1, r2, b2, c2):
    res = 0
...
r1_opt1, b1_opt1, c1_opt1, r2_opt2, b2_opt2, c2_opt2 = popt

I_data.sort()

I_range = np.linspace(I_data[0], I_data[-1], 1000)

R1_fit = R1_final(I_range, r1_opt1, b1_opt1, c1_opt1, r2_opt2, b2_opt2, c2_opt2)
